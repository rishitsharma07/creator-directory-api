...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        Creator ananya = creatorRepository.save(Creator.builder().name("Ananya Iyer").niche("travel").followerCount(8000).engagementRate(6.4).email("ananya@example.com").build());
